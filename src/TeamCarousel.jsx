        ...
        {team.map((member, idx) => (
          <div key={idx} className="flex-shrink-0 w-48 flex flex-col items-center">
            ...
            <div className="flex gap-2 text-gray-400">
              <span className="cursor-pointer hover:text-brand-green">🐦</span> {/* Twitter */}
              <span className="cursor-pointer hover:text-brand-green">📘</span> {/* Facebook */}
              <span className="cursor-pointer hover:text-brand-green">🌐</span> {/* Google+ */}
            </div>
          </div>
        ))}
      </div>
